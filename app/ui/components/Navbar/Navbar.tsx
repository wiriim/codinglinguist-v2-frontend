...
export default function Navbar() {
  return (
    <div className="flex p-5 justify-between sticky top-0 bg-white z-50">
      ...
      <div className="flex gap-12 text-[20px]">
        <Link href={"/login"} className="h-[50px] flex justify-center items-center cursor-pointer">
          Login
        </Link>
        <Link href={"/signup"} className="rounded-[15px] bg-black text-white w-[165px] h-[50px] flex justify-center items-center cursor-pointer">
          Start Now
        </Link>
      </div>
    </div>
